...
# Directory paths
TRAIN = "./scenario/Bravo/TRAIN"
TEST = "./scenario/Bravo/TEST"
VAL = "./scenario/Bravo/VAL"
...
# Path coordinates
# PATHS = [
#     {"name": "P1", "start_lat": 38.20965, "start_lon": 8.261966, "end_lat": 38.20965, "end_lon": 20.356376},
#     {"name": "P2", "start_lat": 36.534355, "start_lon": 8.261966, "end_lat": 36.5296, "end_lon": 20.356376},
#     {"name": "P3", "start_lat": 34.116951, "start_lon": 15.003148, "end_lat": 39.657553, "end_lon": 14.921609}
# ]

PATHS2 = [
    {"name": "P1", "start_lat": 38.20965, "start_lon": 8.261966, "end_lat": 38.20965, "end_lon": 20.356376},
    {"name": "P2", "start_lat": 36.534355, "start_lon": 8.261966, "end_lat": 36.5296, "end_lon": 20.356376},
    {"name": "P3", "start_lat": 33.777445, "start_lon": 14.923951, "end_lat": 38.548577, "end_lon": 14.92395}
]
            ...
            while True:
                try:
                    for path in PATHS2:
                        ...
                        lat, lon = generate_random_lat_long_within_percentage(path, 0.5)  # Spawn within first 50% of the path
                        time_str = time.strftime("%H:%M:%S.%f")[:-3]
                        file.write(f'{time_str}>CRE {plane_name}, B747, {lat},{lon}, 50, 10000, 300\n')
                        file.write(f'{time_str}>DEST {plane_name}, {path["end_lat"]},{path["end_lon"]}\n')
